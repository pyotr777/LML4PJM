#!/usr/bin/perl -w
#*******************************************************************************
#* Copyright (c) 2011-2015 Forschungszentrum Juelich GmbH.
...
#*
#* Contributors:
#*    Peter Bryzgalov (RIKEN AICS), Wolfgang Frings, Carsten Karbach (Forschungszentrum Juelich GmbH) 
#*******************************************************************************/ 
use strict;
use Term::ANSIColor;

print colored ['blue'], "Running PJM/da_system_info_LML.pl\n";
